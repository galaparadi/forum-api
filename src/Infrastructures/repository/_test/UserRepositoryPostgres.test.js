...
describe('UserRepositoryPostgres', () => {
  ...
  describe('checkUserExistenceById', () => {
    it('should throw not found if user doesn\'t exist', async () => {
      ...
      // Action & Assert
      await expect(userRepositoryPostgres.checkUserExistenceById('user-123')).rejects.toThrowError(NotFoundError);
    });
    ...
    it('should return user if exist', async () => {
      ...
      // Action
      const registeredUser = await userRepositoryPostgres.checkUserExistenceById('user-123');
